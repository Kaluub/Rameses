...
class TournamentData {
    constructor(data) {
        ...
        this.topFormat = data?.topFormat ?? data?.format ?? "[{position}] [{player}]";
        this.bottomFormat = data?.bottomFormat ?? "- {area} ;; {time} ;; {attempt}";
...
export { AccountData, TournamentData, TournamentPlayerRunData, WikiPageData, DiscordUserData, DiscordGuildData };